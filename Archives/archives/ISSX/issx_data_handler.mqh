   ...
   bool CopyProjection(const string src_path,const string dst_path,ForensicState &io_state)
     {
      ...
      const string src_norm=ISSX_Util::Lower(ISSX_Util::Trim(src_path));
      const string dst_norm=ISSX_Util::Lower(ISSX_Util::Trim(dst_path));
      if(src_norm==dst_norm)
        {
         io_state.checkpoint="projection_same_path_noop";
         return true;
        }
