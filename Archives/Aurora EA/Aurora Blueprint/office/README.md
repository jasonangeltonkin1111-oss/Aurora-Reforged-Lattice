...
When selecting the current run under `Aurora Blueprint/runs/`, use the highest numbered `AURORA_RUN_###.md` file name.
Do not rely on file modification time when timestamps are tied.
